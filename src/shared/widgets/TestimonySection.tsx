                            ...
                            <div className="h-full bg-gray-100 p-8 rounded">
                                ...
                                <div className="inline-flex items-center">
                                    ...
                                    <span className="flex-grow flex flex-col pl-4">
                                        <span className="title-font font-medium text-gray-900 cursor-pointer">Holden Caulfield</span>
                                        <span className="text-gray-500 text-sm cursor-pointer">UI DEVELOPER</span>
                                    </span>
                                </div>
                            </div>
                        </div>
